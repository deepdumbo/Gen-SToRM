...
params['directory'] = '/Users/zouqing/gen_storm/'
params['filename']  = '/Users/zouqing/gen_storm/Series8.mat'
...
# Training
G,z,train_hist,SER1 = optimize_generator(dop,G,z,params,train_epoch=1000,proj_flag=False)
...
#Training
G,z1,train_hist,SER2 = optimize_generator(dop,G,z,params,train_epoch=600,proj_flag=True)
